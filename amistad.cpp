...
public:
    ...
    void Proceso(void);
    void Imprimir(void);
    friend void Promedio(Operario, Vendedor, Gerente); // Declaración de amistad
    friend void archivo(Operario, Vendedor, Gerente);
    friend void vocal(Operario, Vendedor, Gerente);
};
...
void Promedio(Operario x, Vendedor y, Gerente z) {
    float pr = 0.0;
    pr = (x.salario + y.salario + z.salario) / 3.0;
    cout << "El promedio de salarios es: " << pr << endl;
}
void archivo(Operario x, Vendedor y, Gerente z) {
...
void vocal(Operario x, Vendedor y, Gerente z) {
